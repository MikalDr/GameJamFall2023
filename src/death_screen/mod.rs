...
use self::systems::{layout::{spawn_death_menu, despawn_death_menu}, interactions::{interact_with_retry_button, quick_respawn}};
...
impl Plugin for DeathMenuPlugin {
    fn build(&self, app: &mut App) {
        app
        .add_systems(OnEnter(GameState::Dead), quick_respawn)
